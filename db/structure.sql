...
--
-- Name: first_five_hundred_period_new_high_reports; Type: MATERIALIZED VIEW; Schema: public; Owner: -
--

CREATE MATERIALIZED VIEW public.first_five_hundred_period_new_high_reports AS
 SELECT t2.symbol
   FROM ( SELECT t.id,
            t.symbol,
            t.company_name,
